...
/**
 * check97 - checks for the correct number of argumrnts
 ...
 * @check: check if tru or false
 * @file: file_from name
 * @fd_from: file descriptor
 * @fd_tp file descriptor of file_to, or -1
 * Return: void
 */
...
/**
 * check100 - checks if file descriptor were close properly
